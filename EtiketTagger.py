  ...
  if event.is_private:
    async for usr in client.iter_participants(event.chat_id):
     ...
     return await event.reply(f"{ad} {startmesaj}", buttons=(
                      ...
                      [
                       Button.url('📚  komutlar ', f'https://t.me/diyarbakirsohbet2121'), #komutların olduğu kanal
                       Button.url('👨‍💻  Sahip  ', f'https://t.me/Dalton2134')], #sahibin telegram profil linki
                       [Button.url('📝  Kanal  ', f'https://t.me/diyarbakirsohbet2121')] #Kanalın destek grubu vs
                    ),
                    link_preview=False)
    ...
    async for usr in client.iter_participants(event.chat_id):
     ...
     await event.edit(f"{ad} {startmesaj}", buttons=(
                      [
                       Button.url('🎉  beni gruba davet et 🎉', f'https://t.me/{USERNAME}?startgroup=a')],
                      [Button.url("📚  komutlar ", f'https://t.me/diyarbakirsohbet2121'), #komutların olduğu kanal
                       Button.url('👨‍💻  Sahib  ', f'https://t.me/Dalton2134')] #sahibin telegram profil linki
                       [Button.url('📝  Kanal  ', f'https://t.me/diyarbakirsohbet2121')] #Kanalın destek grubu vs
                    ),
                    link_preview=False)
...
async def handler(event):
    await event.edit(f"{komutlar}", buttons=(
                      [
                      Button.url('📣 Sohbet grubu  ', f'https://t.me/diyarbakirsohbet2121'), #destek grubun linki
                      Button.url('📣 SAHİP ', f'https://t.me/Dalton2134') #sahibin telegram profil linki
                      ],
                      [
...
async def mentionall(event):
  ...
  if mode == "text_on_cmd":
    await client.send_message(event.chat_id, " 📢 üyeleri etiketleme işlemi başladı . . .",
                    buttons=(
                      [
                      Button.url('📝  𝖪ANAL  📝', f'https://t.me/diyarbakirsohbet2121')
                      ]
                    )
                  ) 
    ...
    async for usr in client.iter_participants(event.chat_id):
      ...
      if event.chat_id not in etiket_tagger:
        await event.respond("⛔ üyeleri etiketleme işlemi durduruldu . . .",
                    buttons=(
                      [
                       Button.url('📝  KANAL  📝', f'https://t.me/diyarbakirsohbet2121')
                      ]
                    )
                  )
        return
...
print(">> Bot çalışmaktadir merak etme 🚀 @Dalton2134 bilgi alabilirsin. <<")
client.run_until_disconnected()
